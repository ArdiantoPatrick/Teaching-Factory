...
{
    public class MasterServiceAdvisorController : Controller
    {
        ...
        public MasterServiceAdvisorController(ApplicationDbContext applicationDbContext)
        {
        ...
        public IActionResult Index()
        {
            ...
            var data = _applicationDbContext.tbl_Prodi.Where(q => q.status == "Aktif" && q.role == "Service Advisor").ToList();
            return View(data);
        }
        ...
        public IActionResult Update(int id)
        {
            ViewBag.idadm = HttpContext.Session.GetInt32("idprodi");
            ViewBag.namaadm = HttpContext.Session.GetString("namaprodi");
            Prodi serviceadvisor = _applicationDbContext.tbl_Prodi.Find(id);
